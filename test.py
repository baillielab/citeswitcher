...
text0 = u'this is some ´ ` ´´®†©¨¥© text with a in [@bibtexid] in it  (‘A2B trial’).'
...
text2 = u'In addition to the sedative effect for which illness[@KimEffectsdexmedetomidineratio2014; @Sedationimprovesearly2009], which may mediate'
text3 = u'In addition to direct sedative effects on the central nervous system, alpha_2-agonistsmodulate [@bibtexid; PMID:1234xx1243]. We hypothesise that detectable, modifiable inflammator signals in peripheral blood cause delirium in some patients[@bibtexid] Also \\cite{bibtexid}.'
